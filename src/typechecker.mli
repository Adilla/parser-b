...
val type_expression : Global.t -> Btype.Unif.t -> Local.t -> p_expression -> t_expression Error.t_result
val type_predicate  : Global.t -> Btype.Unif.t -> Local.t -> p_predicate  -> t_predicate Error.t_result
val type_substitution  : Global.t -> Btype.Unif.t -> Local.t -> p_substitution -> t_substitution Error.t_result
