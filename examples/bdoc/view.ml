...
type  t_component = {
  ...
  clause_includes: (loc*(loc,unit) machine_instanciation list) option;
  clause_promotes_included_operation: (loc*u_ident list) option;
  clause_promotes_imported_operation: (loc*u_ident list) option;
  clause_full_inclusion: (loc*(loc,unit) machine_instanciation list) option; (*extends in machine/refinement*)
  clause_full_importation: (loc*(loc,unit) machine_instanciation list) option; (*extends in implementation*)
  ...
  clause_imports: (loc*(loc,unit) machine_instanciation list) option;
}
