---
title: B Language Visibility Rules
---
...
Included (E) (2) | no               | yes        | yes       | yes    | yes
...
|                              | INCLUDES/EXTENDS | PROPERTIES | INVARIANT | ASSERT | OPERATIONS 
-------------------------------|------------------|------------|-----------|--------|-----------
Refined (E) and Refinement (D) | yes              | yes        | yes       | yes    | yes
...
Included (E) (2) | no               | no         | yes       | yes    | yes (ro)
...
Refined (E)        | yes             | yes        | yes    | yes       | yes          | yes               | yes
Seen (E)           | yes             | yes        | yes    | yes       | yes          | yes               | yes
Imported (E) (2)   | no              | yes        | yes    | yes       | yes          | yes               | yes
...
|                                  | IMPORTS/EXTENDS | PROPERTIES | VALUES | INVARIANT | ASSERT/WHILE | LOCAL\_OPERATIONS | OPERATIONS 
-----------------------------------|-----------------|------------|--------|-----------|--------------|-------------------|-----------
Refined (E) and Implementation (D) | yes             | yes        | yes    | yes       | yes          | yes               | yes
Refined (E) and Imported (E)       | no              | yes        | yes    | yes       | yes          | yes               | yes
...
Refined (E) and Imported (E)| no              | no         | no     | yes       | yes          | yes (rw)          | yes (ro)

### Hybrid Variable

|                                  | IMPORTS/EXTENDS | PROPERTIES | VALUES | INVARIANT | ASSERT/WHILE | LOCAL\_OPERATIONS | OPERATIONS 
-----------------------------------|-----------------|------------|--------|-----------|--------------|-------------------|-----------
Refined (E) and Implementation (D) | no              | no         | no     | yes       | yes          | yes (rw)          | yes (rw)
Refined (E) and Imported (E)       | no              | no         | no     | yes       | yes          | yes (rw)          | yes (ro)
...
(2) This line also applies when the data is declared in a machine included both by the refinement and the refined machine
(D) Data declared in the component
(E) Data exported by the component. A data is exported by a component if
  - it is declared in the component,
  - or it is concrete (ie not abstract) and it is exported by the refined machine
  - or it is exported by an included/extended/imported component.
